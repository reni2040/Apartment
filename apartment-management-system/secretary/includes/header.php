...
<head>
    ...
    <title>Secretary Dashboard - <?= htmlspecialchars($config['society']['name'] ?? 'Apartment Management System') ?></title>
        ...
        <aside class="w-64 bg-white shadow-lg">
            <div class="p-6">
                <div class="flex items-center space-x-3">
                    ...
                    <span class="text-xl font-bold text-gray-900">Secretary Portal</span>
                </div>
            </div>
            <nav class="mt-6 space-y-2">
                ...
                <a href="events.php" class="flex items-center px-4 py-2 text-sm font-medium text-gray-700 hover:bg-indigo-50 hover:text-indigo-600 rounded-lg">
                    <img class="h-4 w-4 mr-3" src="https://img.icons8.com/ios-filled/50/000000/calendar.png" alt="Events">
                    Events
                </a>
                <a href="facility_bookings.php" class="flex items-center px-4 py-2 text-sm font-medium text-gray-700 hover:bg-indigo-50 hover:text-indigo-600 rounded-lg">
                    <img class="h-4 w-4 mr-3" src="https://img.icons8.com/ios-filled/50/000000/building.png" alt="Facility Bookings">
                    Facility Bookings
                </a>
            </nav>
        </aside>
        ...
        <main class="flex-1 p-6">
            <header class="mb-6">
                ...
                <p class="text-sm text-gray-500 mt-1">
                    Welcome back, <?= htmlspecialchars($_SESSION['username'] ?? 'Secretary') ?>!
                </p>
            </header>