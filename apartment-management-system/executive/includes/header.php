...
<head>
    ...
    <title>Executive Dashboard - <?= htmlspecialchars($config['society']['name'] ?? 'Apartment Management System') ?></title>
        ...
        <aside class="w-64 bg-white shadow-lg">
            <div class="p-6">
                <div class="flex items-center space-x-3">
                    ...
                    <span class="text-xl font-bold text-gray-900">Executive Portal</span>
                </div>
            </div>
        ...
        <main class="flex-1 p-6">
            <header class="mb-6">
                ...
                <p class="text-sm text-gray-500 mt-1">
                    Welcome back, <?= htmlspecialchars($_SESSION['username'] ?? 'Executive') ?>!
                </p>
            </header>