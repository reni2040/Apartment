...
<head>
    ...
    <title>Owner Dashboard - <?= htmlspecialchars($config['society']['name'] ?? 'Apartment Management System') ?></title>
        ...
        <aside class="w-64 bg-white shadow-lg">
            <div class="p-6">
                <div class="flex items-center space-x-3">
                    ...
                    <span class="text-xl font-bold text-gray-900">Owner Portal</span>
                </div>
            </div>
